...
## Corpus Check
- 136 files · ~39,802 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1003 nodes · 1705 edges · 70 communities (60 shown, 10 thin omitted)
...
1. `normalizeDecision()` - 38 edges
2. `FalkorDB Server Service` - 21 edges
3. `FalkorDbService` - 18 edges
4. `DecisionEvent` - 17 edges
5. `EventsGateway` - 17 edges
6. `compilerOptions` - 16 edges
7. `compilerOptions` - 16 edges
8. `scripts` - 15 edges
9. `scripts` - 15 edges
10. `ApiController` - 15 edges

## Surprising Connections (you probably didn't know these)
- `main()` --calls--> `extractShortTailKeywords()`  [INFERRED]
  backend/scripts/smoke-agents.ts → agents/src/news-utils.ts
...
Cohesion: 0.26
Nodes (11): FalkorRow, parseFalkorRows(), rowFlag(), rowString(), main(), queryRows(), main(), q() (+3 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (27): ApiController, MarketplaceController, MARKETPLACE_CATALOG, MarketplaceAgentDef, AgentSession, AutonomousAgentStreamService, FalkorDB Server Service, FalkorDbService (+19 more)
...
Cohesion: 0.06
Nodes (71): countQuery(), CypherDeltaResult, cypherNodeLabel(), cypherRelType(), executeCypherDelta(), GraphQueryFn, targetIds(), computeGraphDelta() (+63 more)
...
Cohesion: 0.10
Nodes (30): ASSET_TOKENS, buildCorrelations(), buildSearchQueries(), CorrelatedMarketsAgent, expandKeywords(), extractAssets(), FETCH_TIMEOUT_MS, fetchKalshiMarkets() (+22 more)
...
Cohesion: 0.21
Nodes (12): BATCH, CLOSE_TRADE_OF, DECISIONS_DIR, main(), mapAction(), primaryMarketForTrade(), RawEdge, RawEvent (+4 more)
...
Cohesion: 0.22
Nodes (15): firstExistingPath(), loadDecisionFiles(), loadGeminiDeltas(), parseDecisionFile(), remapUserNodeId(), REPO_ROOT_CANDIDATES, resolveDecisionsDir(), resolveGeminiDeltasPath() (+7 more)
...
Cohesion: 0.09
Nodes (34): AgentSessionRecord, attachSessionAgents(), beginSession(), ensureParent(), finalizeSession(), formatSessionMarkdown(), SessionStatus, writeSession() (+26 more)

### Community 56 - "Community 56"
Cohesion: 0.13
Nodes (17): clobAgent, executeClobTrade(), FETCH_TIMEOUT_MS, fetchJson(), getClobQuote(), CLOB, WHALE_NODE_TYPES, ClobExecuteRequest (+9 more)
...
## Knowledge Gaps
- **441 isolated node(s):** `name`, `private`, `workspaces`, `dev`, `dev:backend` (+436 more)
...
- **Why does `main()` connect `Community 54` to `Community 49`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `ApiController` connect `Community 2` to `Community 67`, `Community 4`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `extractShortTailKeywords()` connect `Community 49` to `Community 54`?**
